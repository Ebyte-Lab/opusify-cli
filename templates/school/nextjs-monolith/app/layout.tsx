  ...
  return (
    <aside className="w-64 border-r border-border bg-card min-h-screen p-6 flex flex-col justify-between">
      ...
      <div className="border-t border-border pt-4 mt-4">
        <p className="text-xs text-text-secondary mb-2 uppercase tracking-wider">Role</p>
        <div className="flex flex-col gap-1">
          <button className="text-left px-4 py-2 rounded-theme bg-primary text-white text-sm font-medium">
            Admin
          </button>
          <button className="text-left px-4 py-2 rounded-theme text-text-secondary hover:bg-bg-secondary text-sm transition">
            Student
          </button>
        </div>
      </div>
